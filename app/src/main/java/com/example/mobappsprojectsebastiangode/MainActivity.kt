    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navView.setNavigationItemSelectedListener {
            ...
            when(it.itemId) {
                ...
                R.id.nav_import -> Toast.makeText(applicationContext, "Cliked Import", Toast.LENGTH_SHORT).show()
                R.id.nav_export -> Toast.makeText(applicationContext, "Cliked Export", Toast.LENGTH_SHORT).show()
